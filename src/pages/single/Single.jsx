          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="details">
                <h1 className="itemTitle">Mona Ahemd</h1>
                <div className="detailItem">
                  <span className="itemKey">Email:</span>
                  <span className="itemValue">monaahmed360@gmail.com</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Phone:</span>
                  <span className="itemValue">+2 01140 116 932</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Adress:</span>
                  <span className="itemValue">
                    Elton St. 234 Garden Yd. Giza
                  </span>
                </div>
                <div className="detailItem">
